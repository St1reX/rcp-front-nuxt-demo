    ...
    >
            ...
            <div class="h-full flex flex-col justify-between px-4 py-6">
                <div>
                    ...
                    <nav class="space-y-4 flex flex-col">
                        <div>
                            <p class="text-xs uppercase text-gray-500 dark:text-gray-400 mb-2 px-1">
                                Urlopy
                            </p>
                ...
                <div class="flex-col space-x-2">
                    <div
                        v-if="sessionStorage.isInRole(Roles.ADMIN)"
                        class="flex flex-col lg:hidden gap-2 mb-6 items-center"
                    >
                        <UButton
                            class="text-center"
                            to="/dashboard"
        ...
        <div class="flex-1 flex h-screen overflow-hidden flex-col">
            ...
            >
                ...
                <div
                    v-if="sessionStorage.isInRole(Roles.ADMIN)"
                    class="hidden lg:flex gap-2 items-center justify-between"
                >
                    <UButton
